ARG DOCKER_REMOTE
ARG JF_URL
FROM ${JF_URL}/${DOCKER_REMOTE}/python:3.11.13-bullseye as builder
...
RUN echo "deb https://${JF_USER}:${JF_PASSWORD}@${JF_URL}/artifactory/dvr-game-debian-remote bullseye main" > /tmp/sources.list 
